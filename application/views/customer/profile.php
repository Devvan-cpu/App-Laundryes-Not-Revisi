            ...
            <div class="container">
                ...
                <div class="container">
                    <div class="page-title-alt">
                        <h2 class="lead" style="color: #0071BC; font-size: 35px;">Profile Akun Laundry</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="" method="POST" style="padding: 2vh 0 10vh 0;">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label" style="color: #0071BC; font-size: 20px; font-weight: 500; margin-top: 2rem;">Kode Akun :</label>
                                    <input value="<?= $data['id_customer']; ?>" type="email" class="form-control" id="exampleFormControlInput1" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label" style="color: #0071BC; font-size: 20px; font-weight: 500; margin-top: 2rem;">Nama :</label>
                                    <input value="<?= $data['name']; ?>" type="email" class="form-control" id="exampleFormControlInput1">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label" style="color: #0071BC; font-size: 20px; font-weight: 500; margin-top: 2rem;">Email :</label>
                                    <input value="<?= $data['email']; ?>" type="email" class="form-control" id="exampleFormControlInput1">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label" style="color: #0071BC; font-size: 20px; font-weight: 500; margin-top: 2rem;">Password :</label>
                                    <input value="<?= $data['password']; ?>_" type="password" class="form-control" id="exampleFormControlInput1">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input value="<?= $data['no_hp']; ?>" type="phone" class="form-control" id="exampleFormControlInput1">
                                </div>
                                <div class=" mb-3">
                                    ...
                                    <input value="<?= $data['alamat']; ?>" class="form-control" id="exampleFormControlTextarea1" rows="3"></input>
                                </div>
                            </form>
                        </div>
                    </div>
