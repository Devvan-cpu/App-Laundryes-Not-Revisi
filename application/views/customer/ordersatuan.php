    ...
    <div class="container">
        ...
        <form action="" style="padding: 2vh 0 10vh 0;">
            ...
            <div class="mb-1">
                ...
                <input type="date" name="tgl_order" class="form-control" id="exampleFormControlInput1" style="width: 50%;">
            </div>
            <div class="mb-1">
                ...
                <input type="date" name="tgl_kembali" class="form-control" id="exampleFormControlInput1" style="width: 50%;">
            </div>
            <div class=" mb-3">
