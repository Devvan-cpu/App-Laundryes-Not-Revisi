        ...
        <div id="services" class="section services">
            <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="<?php echo base_url('customer/aksi_order'); ?>" method="POST" style="padding: 2vh 0 10vh 0;">
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        <select required id="disabledSelect" class="form-control" name="pilih_pakaian">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="date" name="tgl_pesan" onchange="gettimeadd(this.value)" class="form-control" id="exampleFormControlInput1" required>
                                </div>
                                <button type="submit" class="btn btn-primary btn-lg" style="margin-top: 5vh; float: right; margin-bottom: 10vh;">Order</button>
                            </form>
                        </div>
                    </div>
                </div>
