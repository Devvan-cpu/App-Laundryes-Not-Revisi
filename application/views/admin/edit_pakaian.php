        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <form action="<?= base_url('admin/update_pakaian') ?>" method="POST">
                                <div class="form-group row">
                                    <label for="email" class="col-sm-2 col-form-label">No Pakaian</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="id_pakaian" name="id_pakaian" value="<?= $id_pakaian['id_pakaian']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="text" class="col-sm-2 col-form-label">Jenis Pakaian</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="jenis_pakaian" name="jenis_pakaian" value="<?= $id_pakaian['jenis_pakaian']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="text" class="col-sm-2 col-form-label">Harga Pakaian</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="harga_pakaian" name="harga_pakaian" value="<?= $id_pakaian['harga_pakaian']; ?>">
                                    </div>
                                </div>
