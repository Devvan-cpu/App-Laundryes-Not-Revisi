                        ...
                        <div class="col-lg-8">
                            <form action="<?= base_url('admin/update_petugas') ?>" method="POST">
                                <div class="form-group row">
                                    <label for="email" class="col-sm-2 col-form-label">No Petugas</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="id_login" name="id_login" value="<?= $id_login['id_login']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-sm-2 col-form-label">Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" value="<?= $id_login['name']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="email" name="email" value="<?= $id_login['email'] ?>">
                                    </div>
                                </div>
                                <div class=" form-group row">
                                    <label for="password" class="col-sm-2 col-form-label">Password</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="password" name="password" value="<?= $id_login['password'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="role_id" id="role_id" class="form-control" value="<?= $role_id ?>" required>
                                            <option value="" disabled selected hidden> - Pilih Role ID - </option>
                                            <?php
                                            foreach ($data as $role) {
                                            ?>
                                                <option value="<?= $role->id_role; ?>"><?php
                                                                                        if ($role->id_role == 1) {
                                                                                            echo 'Admin';
                                ...
                                <div class="box-footer float-right">
                                    <a href="<?= base_url() ?>admin/petugas" class="btn btn-warning"><i class="fas fa-angle-double-left"></i> Kemabali</a>
